<div class="wrap <?php echo ( $show_plug ) ? 'good-person' : 'bad-person'; ?>">
	...
	<p>WP Meetup fetches the latest updates to your meetup events every hour and updates your event posts accordingly.  However, if you want recent changes to be reflected immediately, you can force an update.</p>
	<p>
